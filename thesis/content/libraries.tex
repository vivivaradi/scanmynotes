...
%TODO kicsit se-füle se farka mondatok
...
%TODO én nem lábjegyzetbe raknám a tesztelés típusait, hanem egy bekezdésben végigmennék rajta, hogy mik léteznek és ebből mit használsz
...
%TODO az unit teszt nem az első lépése a tesztelésnek, hanem a legkisebb, legelemibb módja. a tesztelésre fordított idő alapján sok helyen egy end-to-end-szerű smoke-tesztet írnak először, ami ha nem megy át, akkor nagy baj van, de amíg nagy változtatások várhatóak, addig nem kell minden kódsor után átírni az összes unitot
%TODO a unit teszteknek nem igazán szokott lenni manuális módja - tippre arra gondoltál, hogy a tesztelésnek van két módja?
%TODO kevésbé vagyok ma fáradt, úgyhogy lehet hoszabban fogok írni mindenhova ;)
...
\end{itemize}
%TODO nekem olvasás közben nem volt egyértelmű, hogy a before / after / beforeclass /afterclass annotációk csak az adott fájlra (teszt-osztályra) vonatkoznak.
...
%TODO ettől izoláltá válnak, ami segíti a determinisztikus viselkedést, de ettől még tartalmazhat race-condictiont vagy random működést, amitől nem-determinisztikus marad.
